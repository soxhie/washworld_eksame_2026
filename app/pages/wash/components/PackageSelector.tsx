...
//   return (
//     <div style={{ display: "flex", margin: "0 20px", height: 68, gap: 4 }}>

//       <div
//         onClick={() => onChange("guld")}
//         style={{
//           flex: 1,
//           background: active === "guld" ? "var(--color-active-bg-transparent)" : "#000",
...
//         style={{
//           flex: 1,
//           background: active === "premium" ? "var(--color-active-bg-transparent)" : "#000",
//           border: "2px solid var(--color-primary)",
...
//         <div style={{ fontSize: "var(--price-light-size)", lineHeight: "var(--price-light-line-small)", color: "#fff" }}>169kr./md</div>
//       </div>

//       <div
//         onClick={() => onChange("brilliant")}
//         style={{
//           flex: 1,
//           background: active === "brilliant" ? "var(--color-active-bg-transparent)" : "#000",
//           border: "2px solid var(--color-primary)",
...
//         <div style={{ fontSize: "var(--price-light-size)", lineHeight: "var(--price-light-line-small)", color: "#fff" }}>199kr./md</div>
//       </div>

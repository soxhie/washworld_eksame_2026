  ...
  return (
    <main style={{ minHeight: "100vh", overflowY: "auto", paddingBottom: 80, display: "flex", flexDirection: "column", alignItems: "center", color: "var(--background)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, gap: 24, padding: "40px 20px", marginBottom: 120 }}>
        <h1 style={{ fontSize: "var(--h2-size)", fontWeight: 800, textAlign: "center", color: "var(--color-primary)" }}>Program afsluttet </h1>
         <Image src="/ChatGPTimage_conture_clear.png" alt="Bil" width={300} height={300} />
         <h2 style={{ fontSize: "var(--h2-size)", color: "#fff", textAlign: "center", padding: "0 30px" }}>Tak for dit besøg</h2>
        <p style={{ fontSize: "var(--body-md-size)", color: "#fff", textAlign: "center", padding: "0 30px" }}>Vi ønsker dig en god tur videre</p>
        ...
        <button onClick={() => router.push("/pages/dashboard")} style={{ color: "var(--color-primary)", background: "none", border: "none", cursor: "pointer", fontSize: "var(--body-md-size)", marginTop: "40px" }}>
          Tilbage til start
        </button>{" "}
      </div>
